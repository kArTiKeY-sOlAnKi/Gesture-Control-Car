...
// note you may want to change the values of the coordinates
// as these values are not universal
// for each module different values are there
// it is recommended that the user first get a range from accelerometer
// then make changes in the code.
void loop() 
{
